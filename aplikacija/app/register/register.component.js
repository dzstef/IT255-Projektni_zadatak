    ...
    return {
        ...
        execute: function() {
            RegisterComponent = (function () {
                ...
                RegisterComponent.prototype.registracija = function () {
                    var _this = this;
                    var data = "username=" + this.registerForm.value.username + "&password=" + this.registerForm.value.password + "&ime=" + this.registerForm.value.ime + "&prezime=" + this.registerForm.value.prezime + "&adresa=" + this.registerForm.value.adresa + "&telefon=" + this.registerForm.value.telefon;
                    var headers = new http_1.Headers();
                    headers.append('Content-Type', 'application/x-www-form-urlencoded');
                    this.http.post('http://localhost/Projekat1/php/registracijaservis.php', data, { headers: headers })
